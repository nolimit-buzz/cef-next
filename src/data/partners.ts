...
// optional — omit it and the logo simply stays white, which is what NSIA
// needs. Partners with no usable asset render as a text wordmark instead.
...
export const oem_partners: readonly Partner[] = [
  { type: "logo", name: "Transsion", white: "/assets/transsion-w.svg", color: "/assets/transsion.svg" },
  ...
  { type: "logo", name: "Cawin", white: "/assets/cawin-w.svg", color: "/assets/cawin.svg" },
